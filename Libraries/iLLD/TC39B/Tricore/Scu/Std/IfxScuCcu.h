...
/** \brief API to set ADAS frequency (with ADAS divider)
 ...
 * \param adasFreq ADAS frequency (fADAS) in Hz
 * \return Actual Adas frequency (fADAS) in Hz
 */
